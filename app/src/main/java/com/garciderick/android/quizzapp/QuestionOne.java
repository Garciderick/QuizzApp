...
public class QuestionOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contextView = inflater.inflate(R.layout.fragment_question_one, container, false);
        batmanImage = (ImageView)contextView.findViewById(R.id.q1_iv);
        radioGroup = (RadioGroup)contextView.findViewById(R.id.q1_rg);
        button = (Button)contextView.findViewById(R.id.q1_nb);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                radioButton1 = (RadioButton)contextView.findViewById(R.id.q1_rb1);
                radioButton2 = (RadioButton)contextView.findViewById(R.id.q1_rb2);
                radioButton3 = (RadioButton)contextView.findViewById(R.id.q1_rb3);

                if (radioButton1.isChecked())
                {
                    AnswerHolder.newAnswerHolder().getAnswers()[0] = getResources().getInteger(R.integer.right_answer);
                    button.setEnabled(true);
                }
                else if (radioButton2.isChecked())
                {
                    AnswerHolder.newAnswerHolder().getAnswers()[0] = getResources().getInteger(R.integer.wrong_answer);
                    button.setEnabled(true);
                }
                ...
                valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        imageView = (ImageView)contextView.findViewById(R.id.q1_iv);
                ...
                else
                {
                    ...
                    if (AnswerHolder.newAnswerHolder().getAnswers()[0] == getResources().getInteger(R.integer.right_answer))
                    {
