 ...
 * {@link QuestionThree.OnFragmentInteractionListener} interface
...
public class QuestionThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contextView = inflater.inflate(R.layout.fragment_question_three, container, false);
        batmanImage = (ImageView)contextView.findViewById(R.id.q3_iv);
        radioGroup = (RadioGroup)contextView.findViewById(R.id.q3_rg);
        button = (Button)contextView.findViewById(R.id.q3_nb);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                radioButton1 = (RadioButton)contextView.findViewById(R.id.q3_rb1);
                radioButton2 = (RadioButton)contextView.findViewById(R.id.q3_rb2);
                radioButton3 = (RadioButton)contextView.findViewById(R.id.q3_rb3);
                if (radioButton1.isChecked())
                {
                    AnswerHolder.newAnswerHolder().getAnswers()[2] = getResources().getInteger(R.integer.wrong_answer);
                }
                else if (radioButton2.isChecked())
                {
                    AnswerHolder.newAnswerHolder().getAnswers()[2] = getResources().getInteger(R.integer.right_answer);
                }
                ...
                valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        imageView = (ImageView)contextView.findViewById(R.id.q3_iv);
                ...
                else
                {
                    ...
                    if(AnswerHolder.newAnswerHolder().getAnswers()[2] == getResources().getInteger(R.integer.right_answer))
                    {
